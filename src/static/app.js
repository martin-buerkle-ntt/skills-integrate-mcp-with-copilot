document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
      ...
      document.querySelectorAll(".signup-btn").forEach((button) => {
        button.addEventListener("click", async (e) => {
          ...
          if (!activity || !email) {
            messageDiv.textContent = "Please enter your email before signing up.";
          ...
          try {
            ...
            if (response.ok) {
              messageDiv.textContent = result.message || `Signed up for ${activity}!`;
  ...
  // Kein zentrales Submit mehr nötig
